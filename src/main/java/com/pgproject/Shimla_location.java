...
/**
 * Servlet implementation class Shimla_location
 */
public class Shimla_location extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Shimla_location() {
        super();
...
//		response.getWriter().append("Served at: ").append(request.getContextPath());
		...
		try {
			...
			PreparedStatement pst= con.prepareStatement("select* from add_pg where city='Shimla'");

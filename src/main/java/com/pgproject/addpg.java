...
public class addpg extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(rs.getString(1)!=null)
		{
			...
			PreparedStatement pst2= con.prepareStatement("insert into add_pg(pg_name,pg_type,state,city,rooms,address,rent,electricity,wifi,television,power_backup,pg_security,parking,cctv,breakfast,lunch,dinner,user_id,email)values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
